...
%% 8. Aplicar SVM Gaussiano con validación cruzada k=10
...
for i = 1:cv.NumTestSets
    ...
    svmModel = fitcecoc(XTrainCV, YTrainCV, 'Learners', templateSVM('KernelFunction', 'gaussian'));  % Entrenar el modelo de SVM Gaussiano
