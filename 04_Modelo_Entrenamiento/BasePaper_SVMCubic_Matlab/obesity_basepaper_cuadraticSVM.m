...
%% 8. Aplicar SVM Cuadrático con validación cruzada k=10
...
for i = 1:cv.NumTestSets
    ...
    svmModel = fitcecoc(XTrainCV, YTrainCV, 'Learners', templateSVM('KernelFunction', 'polynomial', 'PolynomialOrder', 2));  % Entrenar el modelo de SVM Cuadrático
