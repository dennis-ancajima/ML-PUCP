...
%% 8. Aplicar Árbol de decisión con validación cruzada k=10
...
for i = 1:cv.NumTestSets
    ...
    treeModel = fitctree(XTrainCV, YTrainCV);  % Entrenar el modelo de Árbol de decisión
    
    YTestPredicted = predict(treeModel, XTestCV);  % Realizar la predicción
