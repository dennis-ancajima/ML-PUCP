...
for i = 1:cv.NumTestSets
    ...
    knnModel = fitcknn(XTrainCV, YTrainCV, 'NumNeighbors', 5);  % Entrenar el modelo de KNN
    
    YTestPredicted = predict(knnModel, XTestCV);  % Realizar la predicción
...
disp(['Exactitud promedio con validación cruzada (KNN): ', num2str(meanAccuracy*100), '%']);
